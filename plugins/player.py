...
async def not_chat(_, m: Message):
    if m.from_user is not None and m.from_user.id in Config.SUDO:
        ...
        buttons = [
            [
                InlineKeyboardButton('Join', url='https://t.me/malluflix'),
                InlineKeyboardButton('🧩', url='https://t.me/honeybeemovies'),
            ]
            ]
        await m.reply("You can't use this bot in this group", disable_web_page_preview=True, reply_markup=InlineKeyboardMarkup(buttons))
